...
public class GameManagerScript : MonoBehaviour
{
    ...
    public static string[] conditions = new string[] {"audio_only", "visual_only", "contra_visual", "contra_audio", "visual_only", "contra_visual", "contra_audio", "audio_only", "contra_visual", "contra_audio", "audio_only", "visual_only", "contra_audio", "audio_only", "visual_only","contra_visual"};
    public GameObject player; // the player game object
    // audio clips to play for raycasting sounds
    public AudioClip[] audioClips;
    private static Vector3 maze1_intial_location = new Vector3(0.935f, 0.131f, -1.19f);
    private static Vector3 maze2_intial_location = new Vector3(0.935f, 0.131f, 1.196f);
    private static Vector3 maze3_intial_location = new Vector3(0.889f, 0.132f, -1.22f);
    private static Vector3 maze4_intial_location = new Vector3(0.889f, 0.131f, 1.22f); 
   ...
   // AudioSource audioSource = GameManager.GetComponent<AudioSource>();
    ...
    public void NextMaze()
    {
        ...
        //player.transform.position = initial_position[mazeIndex];
        //print("A" + player.transform.position);
