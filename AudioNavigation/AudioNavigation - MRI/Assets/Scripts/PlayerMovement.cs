        ...
        if (other.gameObject.CompareTag("Finish")){
            ...
            if (other.gameObject.CompareTag("SoundWall"))
            {
                ...
                else
                {
                    ...
                    else if(ConditionType[index_maze] == "const_contra_audio2")
                        {
                            collision_number = collision_number + 1;
                    ...
                    else if(ConditionType[index_maze] == "invisible")
                        {
                            print(2);
                            collision_number = collision_number + 1;
                            collision_status = 2;
                    ...
                    else if(ConditionType[index_maze] == "audio_only")
                        {
                            print(12);
                            collision_number = collision_number + 1;
                            collision_status = 12;
                            sample[0] = "Collision audio_only";
                            //Debug.Log(sample[0]);
                            outlet_player.push_sample(sample); 
                            audioSource.Play();
                        }
